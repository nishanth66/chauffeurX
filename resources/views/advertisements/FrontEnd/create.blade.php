...
<div class="col-md-12 col-xs-12 col-sm-12">
    ...
    <div class="col-md-8 col-sm-8 col-xs-10">
        ...
        <h3 class="create-new-ad">Create a new ad</h3>
        <form method="post" action="{{route('advertisements.store')}}" enctype="multipart/form-data">
            ...
            <div class="form-group required">
                ...
                <textarea rows="2" cols="20" name="description" class="form-control create-ad-form create-ad-textarea" placeholder="Get our new Power Honey juice 50%off with this code: ChaufferX" id="description"></textarea>
            </div>
            <div class="form-group required">
                <label>Link</label>
                <input id="link" class="form-control create-ad-form" type="text" name="link" placeholder="Enter the Bussiness Link">
            </div>
            <div class="form-group required">
                <label>Address</label>
                <input id="autocomplete" class="form-control create-ad-form" type="text" name="address" placeholder="Enter the advertisement address" onFocus="geolocate()">
            </div>

            <div class="form-group required">
                <label>Setup your maximum daily budget</label>
                <input type="text" class="form-control create-ad-form max-daily-budget" id="max" name="max_day_budget" >
                ...
                <div class="form-group">
                    ...
                    <label class="switch" for="checkbox">
                        <input type="checkbox" id="checkbox" onchange="checkboxValue()">
                        <div class="slider round"></div>
                    </label>
                    <input type="hidden" name="filter_category" id="filter_category" value="0">
                    <p><i>The cost per impression ina a filtered category is ${{$catCost}}</i></p>
                </div>

                <button type="submit" class="btn btn-primary btn-create-ad" onclick="validateForm(event)" id="launchBtn">Launch</button>
