    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="#" class="logo">
                <b>ChauffeurX</b>
                {{--<center>--}}
                    {{--<img src="{{asset('public/image/chauffeurX.jpg')}}" class="img-circle logo-image img-responsive">--}}
                {{--</center>--}}
            </a>
                            ...
                            {{--</a>--}}
                                ...
                                {{--<li class="user-footer">--}}
                                    ...
                                    <div class="pull-right">
                                        <a href="{!! url('/logout') !!}" class="btn btn-default btn-flat btn-logout"
        ...
        <footer class="main-footer" style="max-height: 100px;text-align: center">
            <strong>Copyright © 2019 <a href="#">ChauffeurX</a>.</strong> All rights reserved.
        </footer>
...
@else
    ...
    <script src="https://kit.fontawesome.com/001db0bbf1.js"></script>
